...
describe('test discount', function() {
  it('discount with employee and affiliate', () => {
    ...
    /// 990 -> 45
    /// 297 + 45
    const amount = getDiscount(bill.userType, bill.amount, bill.items);
  ...
  it('net payable with empty discount 1', () => {
    ...
    const amount = getBillAftterDiscount(bill);
  ...
  it('only discount percentage with empty usertype', () => {
    ...
    const amount = getDiscountWithPercentage(
      bill.userType,
      bill.amount,
      bill.items
    );
  ...
  it('only discount per money with empty usertype', () => {
    ...
    const amount = getDiscountPerMoney(bill.userType, bill.amount);
  ...
  it('only discount per percentage with grocery 1', () => {
    ...
    const amount = getDiscountWithPercentage(bill.userType, bill.amount, bill.items);
